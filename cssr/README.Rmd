...
Thank you for reading this far! I intend to add more to the vigenette later. For now, you can learn more about the package by reading the bookdown that defines the package [here](https://gregfaletto.github.io/cssr-project/create/).
