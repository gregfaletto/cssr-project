...
* getCssDesign
  - checkNewXProvided confirms that the design matrix provided to getCssDesign matches the characteristics of the matrix that waas provided to css. 
...
getCssPreds, getCssSelections, getCssDesign
...
genLatentData, getLassoLambda, print.cssr
