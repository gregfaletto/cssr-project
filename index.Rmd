...
* `anchoredLambdaGrid()` builds the penalty grid that `cssLasso()` fits its second lasso path over, so that the solution at the target penalty is obtained without also solving the path below it.
