...
promise: measured on this design, `nlambda = 100` yields 66 penalties, not 100). Each mock
...
the last three pin the three new assertions, each of which is otherwise observed by
nothing.
