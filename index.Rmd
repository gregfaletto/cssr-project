...
`plot.cssr()` gives a base-graphics bar plot of the cluster (or feature) selection proportions, sorted in decreasing order, with the `cutoff` drawn as a dashed reference line and the selected clusters (or features) highlighted:
