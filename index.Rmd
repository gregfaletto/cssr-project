...
penalties, and 61 on the `clusterRepLasso()` design the multi-column block uses).
Each mock
...
last block. It is that branch's own disambiguation predicate rather than a post-condition, and
