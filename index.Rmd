...
Test for the empty-selection path of `selected()` and `summary.cssr()` (issue
#107): an empty selection must return clean empty output / a zero-row summary,
NOT trip the `nrow >= 1` / `n_selected_clusts >= 1` assertions inside
`printCssDf()` / `getSelectionPrototypes()`.
