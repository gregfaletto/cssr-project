...
it executes the full (computationally expensive) subsampling procedured
...
- y_train_selec:
  ...
  response corresponding to observation `X[i, ]`. Unlke the more general
  setup of css, y_train_selec must be real-valued because predictions
