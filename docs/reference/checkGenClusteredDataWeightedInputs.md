...
- n_strong_cluster_vars:
  ...
  n_strong_cluster_vars will have a high covariance (rho_high) with the
  latent variable and cluster_size - n_strong_cluster_vars will have a
  low covariance (rho_low) with the latent variable.
